...
export const defaultTextBlocks: TextBlockDefinition[] = [
  ...
  },
  {
    ...
    text: { de: 'Mental Load sichtbar', en: 'Mental load visible', nl: 'Mental Load zichtbaar' },
  },
  {
    ...
    text: { de: 'Individueller Weg', en: 'Individual path', nl: 'Individueel pad' },
  },
  {
    ...
    text: { de: 'Gemeinsamer Prozess', en: 'Shared process', nl: 'Gedeeld proces' },
  },
  {
    ...
    text: { de: 'FairCare bewertet nicht. Es schafft Transparenz.', en: 'FairCare does not judge. It creates transparency.', nl: 'FairCare beoordeelt niet. Het creëert transparantie.' },
  },
  {

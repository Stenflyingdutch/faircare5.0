...
import { completePartnerSession, resolveInvitationByToken, savePartnerSessionAnswer } from '@/services/partnerFlow.service';
    ...
    <section className="section">
      <div className="container test-shell stack">
        ...
        <div className="quiz-actions">
          <button type="button" className="button" onClick={() => setIndex((current) => Math.max(current - 1, 0))} disabled={index === 0 || finishing}>Zurück</button>
          <button type="button" className="button primary" onClick={next} disabled={!session.answers[question.id] || finishing}>
